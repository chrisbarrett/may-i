...
- [x] 4.4 Write test: has with compound value pattern (and + not)
...
- [x] 5.3 Write test: (command (or "cat" "head" "tail")) multi-element or

## 6. Comment/trivia preservation

- [x] 6.1 Write test: comments between top-level forms preserved
- [x] 6.2 Write test: inline comments inside wrapper forms preserved
...
- [x] 8.4 Add any_v1_wrapper generator
- [x] 8.5 Add any_v1_config generator mixing all form types
- [x] 8.6 Add eval-equivalence property test for each new generator
