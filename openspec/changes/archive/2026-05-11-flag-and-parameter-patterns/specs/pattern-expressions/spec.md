...
- **GIVEN** `(rule "kubectl" (parameter ["n" "namespace"] (regex
  "^prod-")) (effect :ask "production cluster"))`
...
- **GIVEN** `(rule "kubectl" (and (parameter ["n" "namespace"] (regex
  ".*")) (positional "get" "pods")))`
...
- **GIVEN** `(rule "git" (and (positional "push") (not (flag ["f"
  "force"]))) (effect :allow))`
- **WHEN** evaluating `git push --force`
- **THEN** the rule SHALL NOT apply
