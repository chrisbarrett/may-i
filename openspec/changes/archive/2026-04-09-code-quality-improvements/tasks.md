...
- [x] 1.2 Extract load_config helper from cmd_eval, cmd_check, cmd_claude_code_hook
- [x] 1.3 Deduplicate CST transform/write_to logic for List vs Vector via shared helper
...
- [x] 3.1 Add #[must_use] to evaluate() in engine crate
- [x] 3.2 Add #[must_use] to EvalResult::new()
- [x] 3.3 Add #[must_use] to key parse functions (parse_config, parse_expr, etc.)
