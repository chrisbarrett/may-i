...
- [ ] 4.2 On merge, write the live Purpose section before running `openspec archive` — auto-archive will otherwise insert `TBD - created by archiving change spec-conventions. Update Purpose after archive.`, which violates this spec's own requirement 6. Use the following Purpose text:
