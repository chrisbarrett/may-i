...
- [ ] 4.1 Run the validator against the current tree and confirm it passes: the
      ...
      are resolved.
- [ ] 4.2 Construct a throwaway post-cutoff archived change with one unchecked
      task, confirm the hook blocks the commit, then remove it.
- [ ] 4.3 Run `cargo fmt --all`, `openspec validate archive-completeness-gate
