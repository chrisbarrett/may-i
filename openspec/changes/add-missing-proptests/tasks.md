...
- [x] 1.1 Add proptest to crates/config/: generate valid config sexpr → parse → serialize → parse → compare
...
- [x] 3.1 Add proptest to crates/engine/src/eval/positional.rs: verify matched + unconsumed = original
- [x] 3.2 Add property: ZeroOrMore is greedy (maximal match)
- [x] 3.3 Add property: matching is deterministic
