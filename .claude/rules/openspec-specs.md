...
3. User-facing specs use `CONTEXT.md` user vocabulary (Rule, Decision, Pattern, Fact, Trust, Authorise, Tail, Style, Parser). Contributor specs may use internals (`Effect`, `Predicate`, `ArgPattern`, `Expr<T>`) and declare audience in Purpose.
